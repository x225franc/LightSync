...
namespace LightConnect.Core
{
    ...
    public class Config
    {
        ...
        // The app was called "Yeelight Connect" before Govee support; its settings are picked up once.
        static readonly string LegacyDataDir =
        ...
        public static Config Load()
        {
            try
            {
                string legacy = Path.Combine(LegacyDataDir, "config.json");
